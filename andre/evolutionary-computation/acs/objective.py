...
def concepts_covered_function(individual, instance, student, timer=Timer()):
    objectives = instance.objectives[student]  # conceitos que foram indicados aos alunos
    concepts_materials = instance.concepts_materials  # para cada conceito um array de 284 materias, onde o valor True indica que aquele material pertence àquele conceito
