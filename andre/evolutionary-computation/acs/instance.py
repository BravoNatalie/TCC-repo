...
class Instance:
    ...
    def load_from_file(cls, config_filename):
        ...
        # print('-----')
        # print('course.material_coverage[39]: ', course.material_coverage[39])
        # print('instance.materials_keys[39]: ', instance.materials_keys[39])
        # print('course.material_coverage[instance.materials_keys[39]]: ',course.material_coverage[instance.materials_keys[39]])
    ...
    def __repr__(self):
        return (f'------\n Cobertura dos materiais: {self.concepts_materials} \n Objetivos do aluno: {self.objectives}\n Habilidades do aluno: {self.student_abilities} \n Dificuldades dos materiais: {self.materials_difficulty} \n Duração dos materiais: {self.estimated_time} \n Duração mínima: {self.duration_min} \n Duração máxima: {self.duration_max} \n Estilo de Aprendizagem dos Materiais: \n\t Ativo | Reflexivo: {self.materials_active_reflexive} \n\t Sensorial | Intuitivo: {self.materials_sensory_intuitive} \n\t Visual | Verbal: {self.materials_visual_verbal} \n\t Sequencial | Global: {self.materials_sequential_global} \n Estilo de Aprendizagem dos Alunos: \n\t Ativo | Reflexivo: {self.student_active_reflexive} \n\t Sensorial | Intuitivo: {self.student_sensory_intuitive} \n\t Visual | Verbal: {self.student_visual_verbal} \n\t Sequencial | Global: {self.student_sequential_global}')
